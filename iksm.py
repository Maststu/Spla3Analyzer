...
#NINTENDO_URL = "https://accounts.nintendo.com/connect/1.0.0/authorize?"
...
def get_nintendo_url(ver, app_user_agent):
	...
	print(auth_code_verifier)
	return f'https://accounts.nintendo.com/connect/1.0.0/authorize?{urllib.parse.urlencode(body)}'




def log_in(ver, app_user_agent, use_account_url):
	'''Logs in to a Nintendo Account and returns a session_token.'''
	# print("login")
	# global S3S_VERSION
	# S3S_VERSION = ver
